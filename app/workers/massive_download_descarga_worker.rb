class MassiveDownloadDescargaWorker
  ...
  def self.perform
    begin
      ...
      request_massive_download.each do |request_massive|
        ...
        massive_download_packages = MassiveDownloadPackage.select_package_process(request_id)
        if massive_download_packages.present?
              ...
              if response.code == "200"
                ...
                if codido_estatus == "5000" && (mensaje.include? "Solicitud Aceptada")
                  ...
                  if result_package != ""
                    ...
                    path = "#{Rails.root}/vendor/descarga_masiva/paquetes/#{package.solicitud_id}/"
          ...
          all_downlaoaded_packages = MassiveDownloadPackage.is_change_estatus_request(request_id)
          if all_downlaoaded_packages
            request_massive.estatus = '7'
  ...
  def take_status(package_id, code)
    package = MassiveDownloadPackage.find_by(solicitud_id: package_id)
