...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cfdi="http://www.sat.gob.mx/cfd/4" xmlns:cce11="http://www.sat.gob.mx/ComercioExterior11" xmlns:donat="http://www.sat.gob.mx/donat" xmlns:divisas="http://www.sat.gob.mx/divisas" xmlns:implocal="http://www.sat.gob.mx/implocal" xmlns:leyendasFisc="http://www.sat.gob.mx/leyendasFiscales" xmlns:pfic="http://www.sat.gob.mx/pfic" xmlns:tpe="http://www.sat.gob.mx/TuristaPasajeroExtranjero" xmlns:nomina12="http://www.sat.gob.mx/nomina12" xmlns:registrofiscal="http://www.sat.gob.mx/registrofiscal" xmlns:pagoenespecie="http://www.sat.gob.mx/pagoenespecie" xmlns:aerolineas="http://www.sat.gob.mx/aerolineas" xmlns:valesdedespensa="http://www.sat.gob.mx/valesdedespensa" xmlns:notariospublicos="http://www.sat.gob.mx/notariospublicos" xmlns:vehiculousado="http://www.sat.gob.mx/vehiculousado" xmlns:servicioparcial="http://www.sat.gob.mx/servicioparcialconstruccion" xmlns:decreto="http://www.sat.gob.mx/renovacionysustitucionvehiculos" xmlns:destruccion="http://www.sat.gob.mx/certificadodestruccion" xmlns:obrasarte="http://www.sat.gob.mx/arteantiguedades" xmlns:ine="http://www.sat.gob.mx/ine" xmlns:iedu="http://www.sat.gob.mx/iedu" xmlns:ventavehiculos="http://www.sat.gob.mx/ventavehiculos" xmlns:detallista="http://www.sat.gob.mx/detallista" xmlns:ecc12="http://www.sat.gob.mx/EstadoDeCuentaCombustible12" xmlns:consumodecombustibles11="http://www.sat.gob.mx/ConsumoDeCombustibles11" xmlns:gceh="http://www.sat.gob.mx/GastosHidrocarburos10" xmlns:ieeh="http://www.sat.gob.mx/IngresosHidrocarburos10" xmlns:cartaporte20="http://www.sat.gob.mx/CartaPorte20" xmlns:pago20="http://www.sat.gob.mx/Pagos20">
  ...
  <!--
	...
	-->
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/utilerias.xslt"/>
  <!--
		En esta sección se define la inclusión de las demás plantillas de transformación para
		la generación de las cadenas originales de los complementos fiscales
	-->
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/donat11.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/divisas.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/implocal.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/leyendasFisc.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40//pfic.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/TuristaPasajeroExtranjero.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/nomina12.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/cfdiregistrofiscal.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/pagoenespecie.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/aerolineas.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/valesdedespensa.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/notariospublicos.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/vehiculousado.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/servicioparcialconstruccion.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/renovacionysustitucionvehiculos.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/certificadodedestruccion.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/obrasarteantiguedades.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/ComercioExterior11.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/ine11.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/iedu.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/ventavehiculos11.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/detallista.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/ecc12.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/consumodeCombustibles11.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/GastosHidrocarburos10.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/IngresosHidrocarburos.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/CartaPorte20.xslt"/>
  <xsl:include href="vendor/schematics/cfdi/strings/strings_complement_40/Pagos20.xslt"/>
